...
facts ={
		...
		"The biggest wildcat today is the Siberian Tiger. It can be more than 3.6 m long (about the size of a small car) and weigh up to 317 kg.",
		...
		"The smallest pedigreed cat is a Singapura, which can weigh just 1.8 kg, or about five large cans of cat food. The largest pedigreed cats are Maine Coon cats, which can weigh 11.3 kg, or nearly twice as much as an average cat weighs.",
		...
		"The lightest cat on record is a blue point Himalayan called Tinker Toy, who weighed 623 g. Tinker Toy was 7 cm tall and 19 cm long.",
		...
		"The normal body temperature of a cat is between 38 °C and 39.1 °C. A cat is sick if its temperature goes below 37.7 °C or above 39.4 °C.",
		...
		"The largest cat breed is the Ragdoll. Male Ragdolls weigh between 5.4 and 9.0 kg. Females weigh between 4.5 and 6.8 k.",
...
function getCatPicURL()
	...
	if statuscode == 200 then
		...
		result = string.sub(result, 34)
		result = result:sub(1, -3)
		
		return "http://random.cat/i/"..result
		
		
	else
	
		--something went wrong duh...
		return "http://s.quickmeme.com/img/8b/8b148de96ba025add3e63494c11b0a0298f4a5b8ec7e636cee43d65f521c996c.jpg"
	--end
...
ts3RegisterModule("cat", registeredEvents)